...
class DessertGame extends StatefulWidget {
  @override
  _DessertGameState createState() => _DessertGameState();
}

class _DessertGameState extends State<DessertGame> {
  int generateRandomNumber(listLength) {
    var random = new Random();
    return random.nextInt(listLength) + 65;
  }
